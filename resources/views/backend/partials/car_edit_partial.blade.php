    ...
    <div class="form-group {{$errors->has('car_condition')? 'has-error' : ''}}">
        ...
        <div class="col-md-6">
            <select name="car_condition" class="form-control input-sm" required>
                ...
                <option
                        value="new"
                        {{ ((old('car_condition')?? $car->car_condition) === 'new') ? 'selected' : '' }}>
                    New
                </option>
                <option
                        value="recondition"
                        {{ ((old('car_condition')?? $car->car_condition) === 'recondition') ? 'selected' : '' }}>
                    Recondition
                </option>
                <option
                        value="used"
                        {{ ((old('car_condition')?? $car->car_condition) === 'used') ? 'selected' : '' }}>
                    Second Hand
                </option>
            </select>
