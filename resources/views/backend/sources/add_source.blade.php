        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal form-bordered" method="post" action="{{ route('store-source') }}">
                        ...
                        <div class="form-group {{$errors->has('source_name')? 'has-error' : ''}}">
                            ...
                            <div class="col-md-6">
                                <input name="source_name" value="{{ old('source_name') }}" type="text"
                                       class="form-control"
                                       id="source_name">
                        ...
                        <div class="form-group {{$errors->has('source_code')? 'has-error' : ''}}">
                            ...
                            <div class="col-md-6">
                                <input name="source_code" value="{{ old('source_code') }}" type="text"
                                       class="form-control"
                                       id="source_code">
